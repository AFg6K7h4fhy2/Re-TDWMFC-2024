...
* Updated version of Demographic-Fiscal model.
* Nonlinear dynamics added to analysis of model.
...
2. Expansion to peak size, in the process acquiring a multiethnic character.
3. Stagnation, decline, and collapse (perhaps followed by a revival, and another imperial cycle).
...
2. Under the circumstances (1), population numbers are rising.
3. Prosperity leads to increased spending to maintain wealth.
4. Higher wealth demands higher expenditures for state security and bureaucracy.
5. Population numbers eventually reach a growth limit.
6. Maintaining prosperity without population growth leads to higher taxation and exploitation of the residents.
7. Higher taxation may ruin the economy and eventually leads to famines, rebellion or political unrest.
